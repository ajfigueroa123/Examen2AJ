            ...
            try
            {
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        comando.Parameters.Add("@Idusuarios", MySqlDbType.VarChar, 45).Value = login.Idusuarios;
                        comando.Parameters.Add("@Contrasena", MySqlDbType.VarChar, 45).Value = login.Contraseña;
